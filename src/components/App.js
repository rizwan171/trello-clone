...
const App = () => {
  ...
  return (
    <div className={"flex flex-col bg-red-400 max-h-screen overflow-hidden " + addMargin}>
      <NavBar />
      {showBoard && <BoardOptionsMenu />}
      <DragDropContext onDragEnd={handleDragEnd}>
        <Droppable droppableId="app" type="list" direction="horizontal">
          {(provided) => (
            <div className="flex px-6 pt-3 overflow-x-auto" ref={provided.innerRef} {...[provided.droppableProps]}>
